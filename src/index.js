...
export default function App() {
    const [darkMode, setDackMode] = useState(false)
    ...
    return (
        <View>
            <StatusBar backgroundColor= {darkMode ? "#282f3b" : "#f5f5f5"} />
          <View style={styles.results}>
            <TouchableOpacity style={styles.themeButton}>
            <Icon name={darkMode ? "sun" : "moon"} size={18} color={darkMode ? "white" : "black"}  onPress={() => darkMode ? setDackMode(false) : setDackMode(true)}/>
            </TouchableOpacity>
